...
describe('ListItemSelector', () => {
  ...
  test('renders with default data and styles', () => {
    ...
    expect(listItemSelector.shadowRoot.querySelector('.list-item-selector')).toBeTruthy();
  });
  ...
  test('renders with mocked items and selected index', () => {
    ...
    const renderedValue = listItemSelector.shadowRoot.querySelector('.list-item-selector-value').textContent;
